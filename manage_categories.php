...
if(!empty($search)){
    $sql  = "select * from categories where category_name like ? order by id desc";
...
$msg = "";
if(isset($_GET['msg'])){
    if($_GET['msg'] == 'added')   $msg = '<div class="alert alert-success"><i class="bi bi-check-circle me-2"></i>Category added successfully!</div>';
    if($_GET['msg'] == 'updated') $msg = '<div class="alert alert-info"><i class="bi bi-check-circle me-2"></i>Category updated successfully!</div>';
    if($_GET['msg'] == 'deleted') $msg = '<div class="alert alert-warning"><i class="bi bi-trash me-2"></i>Category deleted successfully!</div>';
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Manage Categories - FoodieHub</title>
...
<div class="col-md-10">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="add_category.php" class="btn btn-warning fw-bold">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-2">
            <form method="GET" class="d-flex gap-2">
                ...
                <?php if(!empty($search)): ?>
                <a href="manage_categories.php" class="btn btn-outline-secondary">Clear</a>
                <?php endif; ?>
            </form>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="fw-bold">
                                <i class="bi bi-grid me-1 text-warning"></i>
                        ...
                        <td>
                            ...
                            <a href="delete_category.php?id=<?php echo $row['id']; ?>"
                               ...
                               onclick="return confirm('Delete this category? All food items in it will also be deleted!')">
                    ...
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4">
                            ...
                            No categories found. <a href="add_category.php">Add one now</a>
                        </td>
                    </tr>
                    <?php endif; ?>
                    </tbody>
